...
class _MyTicketsListState extends State<MyTicketsList> {
  ...
  Widget _buildTicketList() {
    Selector<MyTicketsListProvider, ApiResponse<GetTicketListResponseModel>?>(
      selector: (_, apiResponse) => apiResponse.getTicketListResponseModel,
      builder: (_, instance, __) {
        if (instance?.status == Status.error) {
          return FittedBox(child: Text(instance?.errorMessage ?? "error"));
        } else if (instance?.status == Status.loading) {
          return const Expanded(child: ProgressBarHUD());
        } else if (instance?.status == Status.completed) {
          List<Datum?> myTicketsListData = instance?.data?.data?.data ?? [];
          ...
          //                                                         ? const Color(
          //                                                             0xff0DA12E)
          //                                                         : myTicketsListData[0]!.status ==
          //                                                                 "On Hold"
          //                                                             ? const Color(
          //                                                                 0xff007CBE)
          //                                                             : myTicketsListData[0]!.status == "Closed"
          //                                                                 ? const Color(0xff15182E)
          //                                                                 : myTicketsListData[0]!.status == "Cancelled"
          //                                                                     ? const Color(0xffD92F1B)
          //                                                                     : Colors.black,
          //                                   ),
          //                                   color: myTicketsListData[0]!
          //                                               .status ==
          //                                           "New"
