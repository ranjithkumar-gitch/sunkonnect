...
NotifiIdTesponseModel notifiIdTesponseModelFromJson(String str) =>
    NotifiIdTesponseModel.fromJson(json.decode(str));

String notifiIdTesponseModelToJson(NotifiIdTesponseModel data) =>
...
class NotifiIdTesponseModel {
  ...
  factory NotifiIdTesponseModel.fromJson(Map<String, dynamic> json) =>
      NotifiIdTesponseModel(
        status: json["status"],
        result: json["result"],
