       ...
       padding: const EdgeInsets.only(bottom: 15,left: 15,right: 15),
         child:  Row(
                                ...
                                SizedBox( height: 40, width: 100,
                                  ...
                                  child: const CustomText(text: 'Cancel', fontSize: 14, fontWeight: FontWeight.w600, textcolor: Colours.kbuttonpurple) 
                                  ...
                                  SizedBox(
                                    ...
                                    style: ElevatedButton.styleFrom(backgroundColor: Colours.kbuttonpurple,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                                      child: const CustomText(text: 'Save', fontSize: 14, fontWeight: FontWeight.w600, textcolor: Colors.white)),
                                  )
                                ],
                               ),
   ),
